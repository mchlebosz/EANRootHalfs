...
inline T Interval<T>::GetWidth() {
	Interval<T> x(this->a, this->b);
	switch (mode) {
		case PINT_MODE: return IntWidth(x);
		case DINT_MODE: return DIntWidth(x);
		default: return IntWidth(x);
	}
}
...
inline Interval<T> Interval<T>::operator+(const Interval<T> &y) {
	...
	Interval<T> r = { 0, 0 };
	switch (mode) {
		case PINT_MODE: r = IAdd<T>(x, y); break;
		case DINT_MODE: r = DIAdd<T>(x, y); break;
		default: r = IAdd<T>(x, y); break;
	}
...
inline Interval<T> operator+(Interval<T> x, const Interval<T> &y) {
	switch (Interval<T>::mode) {
		case PINT_MODE: return IAdd<T>(x, y);
		case DINT_MODE: return DIAdd<T>(x, y);
		default: return IAdd<T>(x, y);
	}
}
...
inline Interval<T> Interval<T>::operator-(const Interval<T> &y) {
	...
	Interval<T> r = { 0, 0 };
	switch (mode) {
		case PINT_MODE: r = ISub<T>(x, y); break;
		case DINT_MODE: r = DISub<T>(x, y); break;
		default: r = ISub<T>(x, y); break;
	}
...
inline Interval<T> operator-(Interval<T> x, const Interval<T> &y) {
	switch (Interval<T>::mode) {
		case PINT_MODE: return ISub<T>(x, y);
		case DINT_MODE: return DISub<T>(x, y);
		default: return ISub<T>(x, y);
	}
}
...
inline Interval<T> Interval<T>::operator*(const Interval<T> &y) {
	...
	Interval<T> r = { 0, 0 };
	switch (mode) {
		case PINT_MODE: r = IMul<T>(x, y); break;
		case DINT_MODE: r = DIMul<T>(x, y); break;
		default: r = IMul<T>(x, y); break;
	}
...
inline Interval<T> operator*(int i, const Interval<T> &y) {
	Interval<T> x = { i, i };
	switch (Interval<T>::mode) {
		case PINT_MODE: return IMul<T>(x, y);
		case DINT_MODE: return DIMul<T>(x, y);
		default: return IMul<T>(x, y);
	}
}
...
inline Interval<T> Interval<T>::operator/(const Interval<T> &y) {
	...
	Interval<T> r = { 0, 0 };
	switch (mode) {
		case PINT_MODE: r = IDiv<T>(x, y); break;
		case DINT_MODE: r = DIDiv<T>(x, y); break;
		default: r = IDiv<T>(x, y); break;
	}
...
inline Interval<T> operator/(Interval<T> x, const Interval<T> &y) {
	switch (Interval<T>::mode) {
		case PINT_MODE: return IDiv<T>(x, y);
		case DINT_MODE: return DIDiv<T>(x, y);
		default: return IDiv<T>(x, y);
	}
}
